...
mkdir baseListCSVs
mv base_list-A3-unrestricted.csv.0 base_list-A3-unrestricted.csv.1 base_list-A3-unrestricted.csv.2 base_list-A4-unrestricted.csv.0 base_list-A4-unrestricted.csv.1 base_list-A4-unrestricted.csv.2 baseListCSVs
