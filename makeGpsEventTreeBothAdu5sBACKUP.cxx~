...
//
    ...
    // POSITION DATA: if lat is illogical (outside Antarctica circle) or altitude is illogical (i.e. when it goes to 0 on gps resets), don't use
    if(pat1->latitude > -66.5|| pat2->latitude > -66.5 || pat1->altitude == 0 || pat2->altitude == 0)
      {
	i1++;
	i2++;
      }
